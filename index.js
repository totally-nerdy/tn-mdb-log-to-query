function tnMongoDBLogToQuery (input) {

  const _replaceOperations = function (input) {
  ...
  try {
    ...
    if (jsonInput.attr && jsonInput.attr.command) {
      ...
      if (command.aggregate) {
        ...
        pipelineString = _replaceOperations(pipelineString)
        ...
        filterString = _replaceOperations(filterString)
